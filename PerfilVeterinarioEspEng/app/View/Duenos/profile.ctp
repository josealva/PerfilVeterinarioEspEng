...
<div id="main">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item text-right">
                    <span class="pull-left"><?php
                        echo $this->Html->link(
                                __('Añadir Mascotas'), '/duenos/add_pet'
                        );
                        ?></span>
                    <div id="clear"></div>
                </li>
                <li class="list-group-item text-right">
                    <span class="pull-left"><a><?php echo __('Eliminar Mascotas') ?></a></span>
                    <div id="clear"></div>
                </li>
                <?php 
                ...
                <li class="list-group-item text-right">
                    <span class="pull-left"><a><?php echo __('Añadir Información de Veterinarias') ?></a></span>
                    <div id="clear"></div>
                </li>
                <li class="list-group-item text-right">
                    <span class="pull-left"><?php
                        echo $this->Html->link(
                                __('Aprobar Adopciones'), 
                                array(
    ...
    <div id='mascotas' class="pull-left col-md-8">
        <p class="title1"><?php echo __('Mascotas') ?></p>
        <?php
        ...
        if ($mascotas) {
            ...
            foreach ($mascotas as $mascota) {
                ...
                echo "<br>";                
                echo __('Edad'). ': ' . $mascota['edad'];
                echo "<br>";
                echo $this->Html->link(__('Editar'), '/duenos/editPet/' . $mascota['id']);             
                echo "<br>";
                echo '</div';
                echo "</li>";
            }
            ...
            echo '<h3>';
            echo __('Ninguna mascota agregada');    
            echo '</h3>';
